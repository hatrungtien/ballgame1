...
IMG_WOOD = pygame.image.load('img/wood.png')
IMG_BACKGROUND = pygame.image.load('img/background.png')
IMG_FRAME = pygame.image.load('img/frame.png')
IMG_THORN = pygame.image.load('img/thorn.png')
IMG_HEART = pygame.image.load('img/heart.png')
IMG_BACKBUTTON = pygame.image.load('img/backButton.png')
IMG_PLAYBUTTON = pygame.image.load('img/playButton.png')
IMG_REPLAYBUTTON = pygame.image.load('img/replayButton.png')
IMG_QUITBUTTON = pygame.image.load('img/quitButton.png')
IMG_HIGHLIGHT = pygame.image.load('img/highlight.png')
IMG_H_START = pygame.image.load('img/headingStart.png')
IMG_H_GAMEOVER = pygame.image.load('img/headingGameover.png')
